...
def test_zmx2yaml():
    ...
    assert opt["coordSys"]["z"] == pytest.approx(0.000000000e00 / 1e3)
    ...
    assert opt["coordSys"]["z"] == pytest.approx(-4.440000000e03 / 1e3)
    ...
    assert opt["coordSys"]["z"] == pytest.approx(-3.008751953e03 / 1e3)
    ...
    assert opt["coordSys"]["z"] == pytest.approx(-3.498751953e03 / 1e3)
    assert opt["coordSys"]["rotX"] == pytest.approx(np.deg2rad(6.000000000e00))
    ...
    assert opt["coordSys"]["y"] == pytest.approx(-1.605042168e02 / 1e3)
    assert opt["coordSys"]["z"] == pytest.approx(-2.743638982e03 / 1e3)
    assert opt["coordSys"]["rotX"] == pytest.approx(np.deg2rad(1.200000000e01))
